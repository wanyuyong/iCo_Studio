...
public class ImageViewTouch extends ImageViewTouchBase {
	...
	private OnImageViewTouchScaleListener mViewScaleListener;
	...
	public void setScrollListener(OnImageViewTouchScrollListener mScrollListener) {
	...
	public void setFlingListener(OnImageViewTouchFlingListener mFlingListener) {
		this.mFlingListener = mFlingListener;
	}

	public void setViewScaleListener(
			OnImageViewTouchScaleListener mViewScaleListener) {
		this.mViewScaleListener = mViewScaleListener;
	}
	
	public OnImageViewTouchScaleListener getViewScaleListener() {
		return mViewScaleListener;
	}
		...
		public boolean onScale( ScaleGestureDetector detector ) {
			...
			if ( mScaleEnabled ) {
				if( mScaled && span != 0 ) {
					...
					mDoubleTapDirection = 1;
					invalidate();
					if(mViewScaleListener != null){
						mViewScaleListener.onScale();
					}
					return true;
				}
