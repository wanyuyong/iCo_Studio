...
public class OutlineContainer extends FrameLayout implements Animatable {
	...
	private void init() {
		...
		mOutlinePaint.setColor(getResources().getColor(R.color.theme_color));
		mOutlinePaint.setStyle(Style.STROKE);

		int padding = (int) DisplayUtil.dpToPx(getResources(), 10);
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		int offset = (int) DisplayUtil.dpToPx(getResources(), 5);
